...
Each handoff file is self-contained: it includes an explicit **First step** with the exact git commands to fetch and create the branch. Execute that first step before doing anything else.
