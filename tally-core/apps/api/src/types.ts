import type {
  ...
  Transaction,
} from "@tally-core/domain";
import type { CsvImportRow, FinanceWorkspaceDocument } from "@tally-core/workspace";
import type { Logger } from "@tally-core/logging";
...
export interface GetReportRequest {
  auth: AuthContext;
  from: string;
  kind: import("@tally-core/workspace").WorkspaceReportKind;
  logger?: Logger;
  to: string;
  workspaceId: string;
}
...
export interface DashboardEnvelope {
  dashboard: ReturnType<typeof import("@tally-core/workspace").buildDashboardSnapshot>;
}
...
export interface CloseSummaryEnvelope {
  closeSummary: import("@tally-core/workspace").CloseSummary;
}
...
export interface ReportEnvelope {
  report: import("@tally-core/workspace").WorkspaceReport;
}
